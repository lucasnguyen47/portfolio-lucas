            ...
            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
              ...
              <div className="w-full flex-1 bg-white border-4 border-black rounded-3xl py-4 px-4 md:py-6 md:px-8 flex flex-col md:flex-row items-center gap-4 md:gap-6">
                ...
                <div className="relative w-full md:w-auto md:min-w-[400px] lg:min-w-[480px]">
                  ...
                  />
                  <Button className="absolute right-2 top-2 bottom-2 bg-black text-white hover:bg-black/90 rounded-[10px] px-6 md:px-10 text-sm md:text-base font-semibold whitespace-nowrap h-auto cursor-pointer">
                    Đăng ký
                  </Button>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12">
            <div>
              ...
              <p className="text-gray-400 mb-6 text-sm leading-relaxed">
                Portfolio chuyên nghiệp với những thiết kế sáng tạo và độc đáo,
            ...
            <div>
              <h3 className="font-bold mb-4">Trang</h3>
            ...
            <div>
              <h3 className="font-bold mb-4">Trang tiện ích</h3>
              <ul className="space-y-2 text-gray-400 text-sm">
                <li>
                  <a
                    href="#"
