          ...
          <div className="group bg-white border-[3px] border-black rounded-3xl overflow-hidden hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-300">
            ...
            <div className="p-6 md:p-8">
              <h3 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">
                Công cụ thiết kế nào phù hợp để lựa chọn trong năm 2023?
              </h3>
          ...
          <div className="space-y-6 md:space-y-8">
              ...
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="p-6 md:p-10 flex flex-col justify-center">
                  <h3 className="text-lg md:text-2xl font-bold mb-3 md:mb-4">
                    Kích thước font trong thiết kế UI: Hướng dẫn đầy đủ để áp
                    dụng
                  </h3>
                  <p className="text-gray-600 text-sm md:text-lg leading-relaxed">
                    Tìm hiểu cách sử dụng kích thước font một cách hiệu quả
            ...
            <div className="group bg-white border-[3px] border-black rounded-3xl overflow-hidden hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-300">
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="p-6 md:p-10 flex flex-col justify-center">
                  <h3 className="text-lg md:text-2xl font-bold mb-3 md:mb-4">
                    6 bài tập thực hành để học trở thành nhà thiết kế UI/UX
                    chuyên nghiệp
                  </h3>
                  <p className="text-gray-600 text-sm md:text-lg leading-relaxed">
                    Khám phá các bài tập thực hành giúp bạn phát triển kỹ năng
                    thiết kế UI/UX một cách hiệu quả
                  </p>
                </div>
              </div>
            </div>
